...
<body>
    <header><h1>Czujniki Kategori 4</h1></header>
    <div class="head">
    <?php
        $counter = $conn->query(" SELECT COUNT(ID) as 'ile' FROM arkusz where kategoria = '4'");
    ...
    <main>
        <ul>
        <?php
            $records = $conn->query(" SELECT arkusz.ID, arkusz.Nazwa, arkusz.CenaCzujnika FROM arkusz where kategoria = '4'");
        ...
        <?php
            $sum = $conn->query("SELECT Sum(CenaCzujnika) as 'suma' from arkusz where kategoria = '4'");
